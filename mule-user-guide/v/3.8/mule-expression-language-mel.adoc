...
This document assumes that you are familiar with Mule and its link:/mule-fundamentals/v/3.8/mule-concepts[basic concepts]. Consider reading the chapter, link:/mule-fundamentals/v/3.8/first-30-minutes-with-mule[First 30 Minutes with Mule] to gain familiarity before proceeding. 
...
<<< I know this is not PR-material, but it is the most effective way to communicate the issue I see:
what does this note mean? Where else might MEL expressions be used? It's best not to assume that someone reading docs has whatever context is in the writer's mind at the time. Most people reading these docs _need to find something out_ - leaving anything to assumption or guessing creates difficulties (either in the form of spurious defect-reports, or support-cases - we cannot afford either of these. Precision is important.
...
* *NEXT STEP*: Learn the link:/mule-user-guide/v/3.8/mule-expression-language-basic-syntax[basic syntax of MEL], or dive into link:/mule-fundamentals/v/3.8/mule-application-architecture[Mule Application Architecture].
...
* Learn better by tutorial? Access the link:/mule-fundamentals/v/3.8/mule-message-tutorial[Mule Message Tutorial].
